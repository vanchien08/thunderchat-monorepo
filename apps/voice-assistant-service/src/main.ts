...
async function bootstrap() {
  await beforeLaunch();
  console.log('>>> Microservice [Voice-Assistant-Service] is launching...');
  ...
  app.connectMicroservice<MicroserviceOptions>({
    ...
    options: {
      ...
      protoPath: join(__dirname, '/../protos/artifacts/voice-assistant.proto'),
      url: '0.0.0.0:50062',
    },
  });
  ...
  console.log(
    '>>> Microservice [Voice-Assistant-Service] is listening on port:',
    PORT,
  );
}
bootstrap();
