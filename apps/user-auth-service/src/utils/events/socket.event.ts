...
import { TActiveCallSession } from '@/call/call.type'
...
export enum ECallListenSocketEvents {
  client_hello = 'client_hello',
  call_request = '_call:request',
  call_accept = '_call:accept',
  call_reject = '_call:reject',
  call_offer_answer = '_call:offer_answer',
  call_ice = '_call:ice',
  call_hangup = '_call:hangup',
}
...
export enum ECallEmitSocketEvents {
  ...
  call_request = '_call:request',
  call_ice = '_call:ice',
  call_status = '_call:status',
  call_offer_answer = '_call:offer_answer',
  call_hangup = '_call:hangup',
  call_timeout = '_call:timeout',
}
